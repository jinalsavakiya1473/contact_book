...
function Addcont() {
  ...
  useEffect(() => {
    localStorage.setItem('token', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjE3MTU3NDQyMDc5OTktNDEyNjg2ODEzIiwiaWF0IjoxNzE1NzQ0MjA3LCJleHAiOjE3MTU5MTcwMDd9.kVQwiFZU7Cm-1a0OEmaCVt2c6E982bpYk69c0_hyRro')
  }, []);
